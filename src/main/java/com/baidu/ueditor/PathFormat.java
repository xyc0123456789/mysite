...
//      return System.currentTimeMillis().makeConcatWithConstants<invokedynamic>(System.currentTimeMillis());
//   }
	private static String getTimestamp () {
   ...
   private static String getSecond() {
	...
	private static String getRandom(String pattern) {
		...
		//      return Math.random().makeConcatWithConstants<invokedynamic>(Math.random()).replace(".", "").substring(0, length);
